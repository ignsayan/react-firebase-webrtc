...
export default function ChatInbox() {
    ...
    return (
        <div className="flex-1 flex flex-col bg-gray-800 text-white shadow-lg">
            ...
            {/* Input Area */}
            <form className="p-4 flex gap-2 bg-gray-800" action={handleReply(activeChatUser.uid)}>
                <input
                    type="text" name="message"
                    placeholder="Type a message"
                    className="flex-1 rounded-full bg-gray-700 text-white focus:outline-none pl-4"
                />
                <button className="bg-blue-600 text-white px-5 py-2 rounded-full hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500"
                >
                    Send Reply
                </button>
            </form>
